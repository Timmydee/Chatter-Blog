  ...
  return (
    <div className={` ${styles.innerWidth} relative`}>
      ...
      <div className="relative z-0">
        <img
          src={chatter1}
          className="object-cover opacity-90 lg:h-full md:h-full h-[60vh]"
        />
        ...
        <div className="w-full absolute lg:top-[30%] top-[30%] text-white mx-auto p-5">
          <div className="mx-auto max-w-[740px]">
            ...
            <div
              className={` ${styles.flexCenter} rounded-2xl cursor-pointer px-2 py-4 w-[157px] border-none bg-[#543EE0] text-white`}
            >
      ...
      {/* About */}
      <div
        className={`${styles.paddings} flex flex-col lg:flex-row lg:items-start items-center lg:justify-between gap-5`}
      >
      ...
      {/* WHy */}
      <div
        className={`${styles.interWidth} mx-auto w-full max-w-[1040px] px-5 lg:px-0`}
      >
        <div className="">
          <h2 className={`${styles.h2Style} text-center`}>
            Why you should Chatter
          </h2>
      ...
      <div
        className={`${styles.paddings} flex flex-col lg:flex-row lg:items-start items-center lg:justify-between gap-5 bg-[#FFEDCC]`}
      >
        <div className="flex lg:flex-row flex-col gap-10">
          ...
          <div className="">
            ...
            <h5 className="my-8">
              Adebobola Muhydeen,{" "}
              <span className="font-light">Software developer at Apple </span>
            </h5>
            <div
              className={` ${styles.flexCenter} rounded-2xl cursor-pointer px-2 py-4 w-[157px] border-none bg-[#543EE0] text-white`}
            >
      ...
      <div className={`${styles.paddings} mx-auto`}>
        <div className="flex lg:flex-row flex-col justify-between items-center gap-5">
          ...
          <div className="max-w-[655px]">
            ...
            <h5 className={`${styles.pStyle} my-7`}>
      ...
      <div className={` `}>
        <div
          className={`${styles.paddings} flex flex-col lg:flex-row items-start lg:justify-between gap-5 bg-[#FFEDCC]`}
        >
          <div>
