      ...
      <div className={`${styles.innerWidth} ${styles.xPaddings}`}>
        <div className="flex justify-between items-center relative">
          ...
          <div onClick={handleMenu} className="lg:hidden">
            ...
            {menu && (
              <div className="absolute bg-green-300 w-[40vw] h-[30vh] p-4 right-0 rounded">
                <ul className="gap-10 text-blue-500 font-medium text-lg">
                  ...
                  <li
                    className={` ${styles.flexCenter} rounded-2xl cursor-pointer px-2 py-4 w-[157px] border border-[#543EE0] text-black`}
                  >
                    <Link to="signin">Log In</Link>
                  </li>
                  <li
                    className={` ${styles.flexCenter} rounded-2xl cursor-pointer px-2 py-4 w-[157px] border bg-[#543EE0] text-white`}
                  >
